...
function PlotsModule({ onDataUpdate }) {
  ...
  useEffect(() => {
    ...
    stampDutyAndRegistrationCharges, totalProjectExtent, totalUnits, totalPhases, selectedOptions,
    projectBuilderDetails, brochure, galleryImages, masterPlanImages, floorAreaPlanImages,
