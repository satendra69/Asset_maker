...
INSERT INTO `ltg_det_plots` VALUES (7,'12301','12301','<p>Test Plots3 Desc</p>\n','VS plots','V.S.Epitome apartments, Bengaluru','560093','17.38714','78.491684','Property Address (If any more detailed)\nProperty Address Details','1230','5000 per Sq-Ft','under_construction','300*300','4','3','south','yes','no','no','12','resale','excluded','12','BBMU','2024','200','15','Acupressure walkway, Badminton Court, Cafeteria, CCTV Surveillance','bout Project/Builder\nProject/Builder Details','https://www.youtube.com/watch?v=1EuNnZEp2sQ','admin','2024-07-24 15:30:31','2024-07-27 12:31:31',5);
...
INSERT INTO `ltg_mst` VALUES (1,'Test Apartment3','Master','Apartments','false','hyderabad','rent','\"[{\"name\":\"Test Apartment3\",\"color\":\"blue\"}]\"','admin','2024-07-24 09:41:21','2024-07-29 10:32:26'),(2,'Test Villa 3','AssetMakers','Villas','true','hyderabad','rent','\"[{\"name\":\"Test Villa 3\",\"color\":\"green\"}]\"','admin','2024-07-24 09:47:44','2024-07-26 17:25:47'),(9,'test  commertial properties3','AssetMakers','CommercialProperties','false','bengaluru','buy','\"[{\"name\":\"test  commertial properties\",\"color\":\"blue\"}]\"','admin','2024-07-24 10:11:45','2024-07-29 10:31:40'),(8,'Test row houses 3','AssetMakers','RowHouses','true','bengaluru','buy','\"[{\"name\":\"Test row houses 3\",\"color\":\"blue\"}]\"','admin','2024-07-24 10:07:24','2024-07-29 10:31:40'),(7,'Test Plots3','AssetMakers','Plots','true','tirupati','rent','\"[{\"name\":\"Test Plots3\",\"color\":\"green\"}]\"','admin','2024-07-24 10:00:31','2024-07-29 10:33:09'),(11,'test  villaments','AssetMakers','Villaments','false','bengaluru','buy','\"[{\"name\":\"test  villaments\",\"color\":\"blue\"}]\"','admin','2024-07-24 10:26:10','2024-07-29 10:32:26'),(12,'test pent houses 3','AssetMakers','PentHouses','true','bengaluru','buy','\"[{\"name\":\"test pent houses\",\"color\":\"blue\"}]\"','admin','2024-07-24 10:30:08','2024-07-29 10:31:40');
...
-- Dump completed on 2024-07-29 17:53:26
